...
consecutive NOPS\cite{zip_quine}, and we believe that is why Drum's metasploit-generated shellcode used a method of
generating a NOP sled that didn't actually use NOP instructions -- simply using regular instructions in a way that has
no side-effects and does no practical work\cite{wiki_sled}.
...
though it is possible. You can, however, create detailed stack dumps, and thus the vulnerability can often serve to
